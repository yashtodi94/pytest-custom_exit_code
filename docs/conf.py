# -*- coding: utf-8 -*-
#
# pytest-custom_exit_code documentation build configuration file, created by
...
project = u'pytest-custom_exit_code'
copyright = u'2015, Yash Todi'
author = u'Yash Todi'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-custom_exit_code Documentation',
     [author], 1)
]
